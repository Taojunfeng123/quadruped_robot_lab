...
##
# use local assets
from robot_lab.assets.openloong import OPENLOONG_LOONG_CFG  # isort: skip


@configclass
class OpenloongLoongRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    base_link_name = "base_link"
    foot_link_name = "Link_ankle_.*_roll"
    ...
    def __post_init__(self):
        ...
        # ------------------------------Sence------------------------------
        self.scene.robot = OPENLOONG_LOONG_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        self.rewards.create_joint_deviation_l1_rewterm(
            "joint_deviation_hip_l1", -0.3, ["J_hip_.*_roll", "J_hip_.*_yaw"]
        )
        self.rewards.create_joint_deviation_l1_rewterm("joint_deviation_ankle_l1", -0.2, ["J_ankle_.*_roll"])
        ...
        if self.__class__.__name__ == "OpenloongLoongRoughEnvCfg":
