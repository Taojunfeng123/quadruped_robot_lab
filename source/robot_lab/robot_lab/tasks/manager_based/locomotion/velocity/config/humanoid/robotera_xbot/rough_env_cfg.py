...
# Pre-defined configs
##
from robot_lab.assets.robotera import ROBOTERA_XBOT_CFG  # isort: skip
...
class RobotEraXbotRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # -------------------------------Scene-------------------------------
        self.scene.robot = ROBOTERA_XBOT_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        if self.__class__.__name__ == "RobotEraXbotRoughEnvCfg":
