...
gym.register(
    ...
    kwargs={
        ...
        "cusrl_cfg_entry_point": f"{agents.__name__}.cusrl_ppo_cfg:FFTAIGR1T2RoughTrainerCfg",
    },
)
...
gym.register(
    ...
    kwargs={
        ...
        "cusrl_cfg_entry_point": f"{agents.__name__}.cusrl_ppo_cfg:FFTAIGR1T2FlatTrainerCfg",
    },
)
