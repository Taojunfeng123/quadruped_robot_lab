...
# Pre-defined configs
##
from robot_lab.assets.magiclab import MAGICLAB_BOT_GEN1_CFG  # isort: skip


@configclass
class MagicLabBotGen1RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # ------------------------------Sence------------------------------
        self.scene.robot = MAGICLAB_BOT_GEN1_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        if self.__class__.__name__ == "MagicLabBotGen1RoughEnvCfg":
