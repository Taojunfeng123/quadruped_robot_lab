...
gym.register(
    id="RobotLab-Isaac-Velocity-Flat-RobotEra-Xbot-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.flat_env_cfg:RobotEraXbotFlatEnvCfg",
...
gym.register(
    id="RobotLab-Isaac-Velocity-Rough-RobotEra-Xbot-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.rough_env_cfg:RobotEraXbotRoughEnvCfg",
